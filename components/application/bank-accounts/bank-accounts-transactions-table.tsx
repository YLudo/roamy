...
import BankAccountAddBudget from "./bank-account-add-budget";
...
const BankAccountsTransactionsTable = ({ transactions, isLoading }: BankAccountsTransactionsTableProps) => {
    ...
    const [selectedTransaction, setSelectedTransaction] = useState<IPlaidTransaction | null>(null);
    ...
    const handleAddToTravel = (transaction: IPlaidTransaction) => {
